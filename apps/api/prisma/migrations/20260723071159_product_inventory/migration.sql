...
-- AlterTable
ALTER TABLE "tenant_invoices" ALTER COLUMN "issuedAt" SET DATA TYPE TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "product_inventory_tenantId_isActive_deletedAt_idx" ON "product_inventory"("tenantId", "isActive", "deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "product_inventory_tenantId_sku_key" ON "product_inventory"("tenantId", "sku");

-- CreateIndex
CREATE UNIQUE INDEX "product_inventory_tenantId_barcode_key" ON "product_inventory"("tenantId", "barcode");
...
-- AddForeignKey
ALTER TABLE "product_inventory" ADD CONSTRAINT "product_inventory_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "product_categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product_inventory" ADD CONSTRAINT "product_inventory_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

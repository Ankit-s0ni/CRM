...
import { AttendanceRuntimeService } from '../core/application/attendance-runtime.service';
import { networkIncludesAddress } from '../configuration/attendance-config.rules';

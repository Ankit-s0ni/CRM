...
export default function AcceptInvitationPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface px-5 py-10">
      <div className="absolute -left-32 top-10 size-96 rounded-full bg-muted/45 blur-3xl" />
      <div className="absolute -bottom-32 right-0 size-[28rem] rounded-full bg-accent/15 blur-3xl" />

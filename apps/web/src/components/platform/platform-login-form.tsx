...
export function PlatformLoginForm() {
  ...
  return (
    <form onSubmit={submit} className="w-full max-w-[430px] rounded-2xl border border-[#ded9eb] bg-white p-8 shadow-[0_24px_70px_rgba(53,37,205,.12)]">
      <div className="mb-7 flex items-center gap-3"><div className="grid size-11 place-items-center rounded-xl bg-[#4f46e5] text-white"><Building2 /></div><div><h1 className="text-xl font-bold">IndigoHR</h1><p className="text-xs font-semibold uppercase tracking-[.15em] text-[#777587]">Platform administration</p></div></div>
